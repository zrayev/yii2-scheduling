...
<?php
/**
 * @var \rubarbs\scheduling\Schedule $schedule
 */
...
First of all, you should include dependency to the `rubarbs\yii2-scheduling` into your composer.json:

```
...
'require': {
    "rubarbs/yii2-schedule": "*"
}
...
```
...
```php
'schedule' => 'rubarbs\scheduling\Schedule',
```
